...
// Assuming useToast, Button, Input, Textarea, and Modal are correctly imported
import { useToast } from "@/hooks/use-toast";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Textarea } from "@/components/ui/textarea";
import { Phone, Mail, MapPin, Clock, ArrowRight, Loader2, Calendar } from "lucide-react";
    ...
    <div className="min-h-screen bg-white dark:bg-black text-gray-800 dark:text-gray-200 pt-20">
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          {/* Contact Info Column (Small & Dark) */}
          <motion.div
          ...
          {/* Contact Form Column (Large & Light) */}
          <motion.div
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <Input
                    ...
                    className="h-12 border-gray-300 dark:border-gray-600 dark:bg-gray-900 focus:border-red-500 focus:ring-red-500"
                    required
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={handleChange}
                  placeholder="Tell us the year, make, and model of your vehicle and the service you are interested in (e.g., Ceramic Coating, Paint Correction, Full Detail)..."
                  rows={8}
                  className="border-gray-300 dark:border-gray-600 dark:bg-gray-900 focus:border-red-500 focus:ring-red-500"
                />
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <Button
                  asChild
                  variant="outline"
                  className="flex-none h-14 px-8 text-lg border-red-600 text-red-600 hover:bg-red-50/10 dark:hover:bg-red-900/10"
                >
      ...
      >
        ...
        <div className="relative h-96 w-full rounded-2xl overflow-hidden shadow-2xl border-4 border-red-600">
          <Image
            ...
            // Setting priority for image loading on a key page section
            priority
          />
